...
The set $P \cup Q$ is also a partition of $[a,b]$. Since $P \subseteq P \cup Q$ and $Q \subseteq P \cup Q$, we can apply [[ross elem analysis/32/lem 32.2|lem 32.2]] to obtain
